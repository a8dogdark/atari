...
TRANSFER
    ...
    BPL TRANSFER
PAUSA
    LDA #$F0    ;800 BAUDIOS NTSC
    ;LDA #$E0    ;800 BAUDIOS PAL
    STA $021C
PAUSA02
    LDA $021C
    BNE PAUSA02
...
EORLISTO
    JSR BAUD.600
    JSR $FD34   ; GRABA LEADER 15 PRIMEROS SEGUNDOS
...
SAVEFALSO
    ...
    DEX 
    BPL SAVEFALSO
    JSR $E459       ;GRABA PRIMER BLOQUE LARGO
...
LOOPTRAMPIX
    ...
    DEX 
    BPL LOOPTRAMPIX
    JSR $E459       ;GRABA SEGUNDO Y TERCER BLOQUE CORTO
...
CAMBIO1
    .WO DATA
    .BY $70,$70,$70,$70,$70,$70,$70,$70,$70,$70
    .BY 65
    .WO DL
DATA
    .SB "   turbo SOFTWARE   "
